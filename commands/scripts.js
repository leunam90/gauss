...
module.exports = {
    ...
    create: () => {
        ...
        inquirer.prompt([{
            ...
            script['abbreviation'] = script_type[answer.type]['abbreviation'];
            script['latest_version'] = script_type[answer.type]['latest_version'];
            inquirer.prompt([{
                type: 'checkbox',
                name: 'entrypoint',
                prefix: '👾',
                ...
                validate: (value) => {
                    if (!value.length) return 'Tienes que tener un entrypoint';
                    return true;
                }
            }]).then((answer) => {
                ...
                inquirer.prompt([{
                    ...
                    const script_name = config.company_abbreviation + '_' + script['abbreviation'] + '_' + answer.name.replace(/\s/g, '_') + '.js';
                    ...
                    template_script = template_script.replace('{author}', script.author)
                        ...
                        .replace('{api_version}', script.latest_version)
